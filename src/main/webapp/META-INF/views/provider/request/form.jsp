...
<acme:form>
	...
	<acme:form-checkbox code="provider.request.form.label.checked" path="checked"/>
		
	<acme:form-submit code="provider.request.form.button.submit" action="/provider/request/create"/>
