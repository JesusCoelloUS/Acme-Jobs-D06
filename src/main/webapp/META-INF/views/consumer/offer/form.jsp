...
<acme:form>
	...
	<acme:form-checkbox code="consumer.offer.form.label.checked" path="checked"/>
		
	<acme:form-submit code="consumer.offer.form.button.submit" action="/consumer/offer/create"/>
